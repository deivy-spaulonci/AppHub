...
public class CidadeRepositoryTest {
    ...
    public void testFindCidadeByUfAndNomeContainingIgnoreCaseOrderByNome() {
        ...
        when(cidadeRepository.findCidadeByUfAndAndNomeContainingIgnoreCaseOrderByNome("SP", "pa"))
                .thenReturn(cidades);

        // Act
        List<Cidade> resultado = cidadeRepository.findCidadeByUfAndAndNomeContainingIgnoreCaseOrderByNome("SP", "pa");
        ...
        verify(cidadeRepository, times(1))
                .findCidadeByUfAndAndNomeContainingIgnoreCaseOrderByNome("SP", "pa");
    }
